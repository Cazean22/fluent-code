...
#[test]
fn mock_provider_streams_assistant_messages() {
    run_exact_app_libtest("runtime::orchestrator::tests::mock_provider_streams_assistant_messages");
}

fn run_exact_app_libtest(module_qualified_test_name: &str) {
    let cargo = std::env::var("CARGO").unwrap_or_else(|_| "cargo".to_string());
    let isolated_target_dir = unique_temp_dir("fluent-code-app-task9-exact-wrapper");
